...
1. **Navigate to Voice Agents Dashboard**
   ...
   ![Voice Agents Integration Tab](/images/limechat/1-voice-agent-integration.png)
...
2. **Locate Account ID**
   ...
   ![Limechat Account ID Location](/images/limechat/2-account-id.png)
...
1. **Access Profile Settings**
   ...
   ![Limechat Profile Button](/images/limechat/3-profile-button.png)
...
4. **Copy the Access Token**
   ...
   ![Limechat Access Token](/images/limechat/4-access-token.png)
