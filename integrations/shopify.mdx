...
8. **Select Required Scopes**
   ...
   ![Configure API scopes](/images/shopify-integration/image_7.png)

9. **Install the App**

   Click **Install app** to activate the app in your store.

   ![Install app](/images/shopify-integration/image_8.png)

   ![Install app confirmation](/images/shopify-integration/image_9.png)
...
10. **Copy Access Token**
    ...
    ![Access token](/images/shopify-integration/image_10.png)
...
11. **Access Voice Agents Dashboard**
    ...
    ![Voice Agents dashboard](/images/shopify-integration/image_11.png)
...
12. **Complete Shopify Connection**
    ...
    ![Connect Shopify](/images/shopify-integration/image_12.png)
