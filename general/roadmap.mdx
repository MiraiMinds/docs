...
| What | Target | Status |
| :--- | :--- | :--- |
| [Post-call analytics on every tier](#post-call-analytics-everywhere) — AI summary + QA score in the v2 API | August 2026 | rolling out |
| [Warm transfer on every tier](#warm-transfer-everywhere) — `ended_reason: transferred` goes live | August 2026 | rolling out |
| [Price ladder](/general/tiers) — T5 pay as you go, T3 and T1 with a monthly commitment, one Mira stack on every tier | September 2026 | ✅ **live** |
| [Campaigns](/v2/campaigns) — server-side dialler with windows, retries, budgets and a report | August 2026 | ✅ **live** |
| [Transcripts + recordings](/v2/calls#get-the-transcript) in the v2 API | August 2026 | rolling out |
...
| [Six new TTS languages](#new-tts-languages) — Telugu, Tamil, Marathi, Kannada, Gujarati, Bengali | September – October 2026 | in development |
| [Next-generation TTS](#next-generation-tts) — the voice engine behind every tier, upgraded | October 2026 | in development |
| Node-based agents on every tier — browser calls today; phone calls for flows next | Q4 2026 | browser calls live; creation in Agent Studio rolling out |
...
| Self-serve Go live and wallet top-ups — from the console | September 2026 | ✅ **live** |
| Self-serve signup | Q4 2026 | design |

## Post-call analytics everywhere

Every call on every tier gets opened: an AI summary and a QA score, on 100% of
calls, not a sample. The capability is part of
[every tier](/general/tiers#one-stack-on-every-tier) today; what lands in August is
...
Six languages join the voice engine over the next two months: **Telugu, Tamil,
Marathi, Kannada, Gujarati and Bengali** — together the mother tongue of 429
million people, most of whom cannot be reached in Hindi at all. Per-language
dates are announced as each clears evaluation. The full story, with the data,
is on the [language roadmap](/v2/tts-languages).
...
same graphs node-based agents run on every tier, authored by your ops team
instead of your engineers. Validation runs as you draw, and every published version is
