...
description: Understand what voice agents are, how they work, and how they can transform your customer interactions.
---
...
- [Shopify Integration](/integrations/shopify) - E-commerce order management
- [WhatsApp Integration](/integrations/whatsapp) - Multi-channel messaging
- [Google Calendar Integration](/integrations/google-calendar) - Appointment scheduling
- [Klaviyo Integration](/integrations/klaviyo) - Marketing automation

Or dive into specific use cases to see voice agents in action:

- [Retail Use Cases](/usecases/retail) - Customer support and sales
- [B2B Use Cases](/usecases/b2b) - Lead qualification and scheduling  
- [Healthcare Use Cases](/usecases/healthcare) - Appointment management and patient support
