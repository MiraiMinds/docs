...
v2 `sk_live_` secret key. Without v1 admin credentials, the voice picker in the
[console](https://sandbox.voice.miraiminds.co) shows the same catalogue, and you
can hear each voice before you pick. Full reference:
[v1 Voice gallery](/v1/assistants#voice-gallery).
