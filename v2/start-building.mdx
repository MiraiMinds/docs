...
Two files come with your key:

| File | What it is |
| :--- | :--- |
| `mirai-voice-sandbox.postman_collection.json` | The collection — every endpoint, with worked example responses. |
| `sandbox.postman_environment.json` | The environment — base URL, your key, your test number. |
