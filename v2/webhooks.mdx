...
| :--- | :--- | :--- |
| `call.queued` | The call is admitted to the queue. **Opt-in** — ask ops to enable it. | `queued` |
...
```json
{
  ...
  "data": {
    "call": {
      ...
      "duration_secs": 18,
      "cost": { "amount_inr": 0.3, "per_min_inr": 1 }
    }
  }
}
```
...
After the sixth attempt the event goes to a dead-letter queue. Ops can replay
