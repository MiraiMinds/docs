...
96 seconds is billed as 2 minutes — ₹2.00. [Minutes are whole and rounded up](/general/tiers#metering), with a one-minute minimum.
</Step>
</Steps>
...
| `402 insufficient_balance` | Wallet cannot cover one minute | Check `GET /v2/wallet`; ask your Mirai contact for a top-up |
