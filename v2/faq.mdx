...
**How do I get a key?**
Email [help@miraiminds.co](mailto:help@miraiminds.co) with your company and use
case. Keys are ops-issued during the pilot; self-serve signup is coming. You get
a secret key, a webhook secret, and a starting wallet balance.
...
**Can I use v1 and v2 at the same time?**
Yes. Different hosts, different credentials, same workspace. Most people move
calls to v2 and leave numbers, knowledge base and tools on v1. See
[Migrating from v1](/v2/migration).
...
Not in v2. Inbound assistants live in [v1](/v1/overview).
...
Not through the v2 API. Recordings are retained 30 days; ask ops if you need
...
₹1 per minute on `t1`, metered per second — no per-call minimum, no rounding
to minutes, no pulses. A 96-second call costs ₹1.60; an 8-second call costs
₹0.13. See [Billing & tiers](/general/tiers).
...
Yes — media went live and audio was generated. An 18-second voicemail costs
18 seconds: ₹0.30 at `t1`.
...
**How do I top up?**
Email [credits@miraiminds.co](mailto:credits@miraiminds.co). Self-serve top-up
is not built yet. Credits land as a `credit` row in
