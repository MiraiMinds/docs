...
Yes — warm transfer to a human is part of every tier, see
[tiers](/general/tiers#one-stack-on-every-tier). The transfer rollout is
...
It depends on your plan. Every company starts on T5 at ₹5 a minute, pay as
you go. A ₹50,000 monthly commitment brings T3 at ₹3 a minute, and ₹1,00,000
brings T1 at ₹1.50 a minute end to end. Calls are billed in 10-second blocks,
rounded up, minimum one block: on T3 a 96-second call costs ₹5.00 and an
8-second call ₹0.50. See [Billing & tiers](/general/tiers).
...
Yes — media went live and audio was generated. An 18-second voicemail is two
billed blocks: ₹1.00 on T3.
...
**How do I top up?**
Once your company has gone live, add credit from the **Billing** page of the
[console](https://sandbox.voice.miraiminds.co); before that, ask your Mirai
contact. Credits land as a `credit` row in
[`GET /v2/wallet/transactions`](/v2/wallet#list-transactions) and take effect
immediately.

**Which tier am I on?**
Your company's plan. Every company starts on T5, pay as you go — complete
**Go live** in the console and you can call today. Commit ₹50,000 a month to
move to T3, or ₹1,00,000 a month to move to T1. Every tier runs on the same
Mira stack; the price is the only difference. See
