...
base/RAG, API tools (function calling), web calls, or post-call analysis.
**v2 has none of these yet.** The two APIs can address the same workspace side
by side — migrate calls first, keep the rest on v1.
