...
genuinely needs to submit more than 500 rows in one batch, ask ops before the
...
Recordings are not exposed through the v2 API. If you need them, ask ops — and
