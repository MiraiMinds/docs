...
3.  **Coupon Generated:** The system connects to your [Shopify store](/integrations/shopify) and automatically generates a unique, time-limited discount coupon.
...
5.  **WhatsApp Follow-up:** Immediately after the call, a [WhatsApp message](/integrations/whatsapp) is sent containing the direct GoKwik checkout link and the unique coupon code, making it easy to complete the purchase.
...
<Note>
**Strictly Read-Only and Action-Specific**
...
2.  **Get Your Webhook Endpoint.**
    ...
    - You can find this unique URL in your abandon cart campaign page on the Voice Agents platform.
      ![Webhook Configuration](/images/guide/webhook.png)
...
```json
{
  ...
  "custPhone": "xxxxxxxxxx",
  "custName": "John Doe",
  "custEmail": "testjohndoe@gmail.com",
  "line_items": [
    {
  ...
  "communicationTime": "",
  "channel": "SHOPIFY",
  "abandonLink": "https://urturms.com/?cart-resume-id=688bb9076b9a7a596ca17cxx&type=report,fastrr,",
  "source": "fastrr",
  "address": "",
...
This is required for automatically generating discount codes. For detailed setup instructions, see our [complete Shopify integration guide](/integrations/shopify).
