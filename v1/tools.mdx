...
<Note>
This page covers legacy v1 tools. For new integrations, use [v2 tools](/v2/tools):
pre-call, on-call, and post-call actions with conditions, workspace secrets,
and synchronous or background execution. v2 tools are defined on each agent;
v1 tool IDs are not accepted as v2 tool definitions.
</Note>
